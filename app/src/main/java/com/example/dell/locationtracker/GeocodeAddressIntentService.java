...
public class GeocodeAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if(addresses==null || addresses.size() == 0)
        {
            ...
            deliverResultToReciever(Constants.FAILURE_RESULT,errorMessage, null);
        }
        else
        {
            ...
            deliverResultToReciever(Constants.SUCCESS_RESULT, TextUtils.join(System.getProperty("line.separator"),addressFragments), address);

        }


    }
    private  void deliverResultToReciever(int resultCode, String message, Address address)
    {
